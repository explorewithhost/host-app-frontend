    ...
    <footer className="footer">
      ...
      <div className="ft-wrap">
        ...
        <div className="ft-bottom">
            ...
            <Link to="/" aria-label="Host Home" className="footer-brand">
                <img src={HostLogo} alt="Host" className="footer-logo" height={22} width="auto" />
            </Link>
            <span className="legal">© {new Date().getFullYear()} Host, Inc. All rights reserved.</span>
            </div>
